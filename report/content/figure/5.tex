\begin{figure}[t]
    ...
    \begin{subfigure}[b]{.24\linewidth}
        \centering
        \resizebox{\linewidth}{!}{\includegraphics{figure/plot/reference/fig5a-overwrite-iter-lat.pdf}}
        \caption{\label{fig:5a:refoverwrite-iter-latency}[Ref]Per-iter latency.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{.24\linewidth}
        \centering
        \resizebox{\linewidth}{!}{\includegraphics{figure/plot/reference/fig5b-overwrite-delay-p99-latency-sample.tikz.pdf}}
